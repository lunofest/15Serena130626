...
function updateTimer() {
  const targetDate = new Date("june 13, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '541138332544'; // Número para el primer botón
  const phoneNumber2 = '543814749416'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '541130196545'; // Número para el primer botón
  const recipientNumber2 = '543814749416'; // Número para el segundo botón
